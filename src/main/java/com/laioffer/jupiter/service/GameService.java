...
public class GameService {
    private static final String TOKEN = "Bearer jwce8as8kyuau8563blfjr13lt0sx8";
    private static final String CLIENT_ID = "w67qfy8c5hs43ywo31lu4ztj35k7pa";
    ...
    private List<com.laioffer.jupiter.entity.response.Game> getGameList(String data){
        ObjectMapper mapper = new ObjectMapper();
        try {
            return Arrays.asList(mapper.readValue(data, com.laioffer.jupiter.entity.response.Game[].class));
    ...
    public List<com.laioffer.jupiter.entity.response.Game> topGames(int limit){
        if (limit <= 0) {
    ...
    public com.laioffer.jupiter.entity.response.Game searchGame(String gameName){
        List<com.laioffer.jupiter.entity.response.Game> gameList = getGameList(searchTwitch(buildGameURL(GAME_SEARCH_URL_TEMPLATE, gameName, 0)));
        if (gameList.size() != 0) {
